...
```bash
# Linux
curl -L https://github.com/kitos9112/terragrunt-gitlab-cicd-config/releases/download/1.1.4/terragrunt-gitlab-cicd-config_1.1.4_linux_x86_64.tar.gz | tar xz

# OS X
curl -L https://github.com/kitos9112/terragrunt-gitlab-cicd-config/releases/download/1.1.4/terragrunt-gitlab-cicd-config_1.1.4_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/kitos9112/terragrunt-gitlab-cicd-config/releases/download/1.1.4/terragrunt-gitlab-cicd-config_1.1.4_windows_x86_64.zip
unzip terragrunt-gitlab-cicd-config_1.1.4_windows_x86_64.zip
```
